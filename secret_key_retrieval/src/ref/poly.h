...
#define dump_poly DILITHIUM_NAMESPACE(dump_poly)
void dump_poly(poly *p, char *name);

#define dump_poly_to_file DILITHIUM_NAMESPACE(dump_poly_to_file)
void dump_poly_to_file(poly *p, char *name, const char *filename);
