...
#define dump_polyveck DILITHIUM_NAMESPACE(dump_polyveck)
void dump_polyveck(polyveck *v, char *name);

#define dump_polyvecl DILITHIUM_NAMESPACE(dump_polyvecl)
void dump_polyvecl(polyvecl *v, char *name);

#define dump_polyveck_to_file DILITHIUM_NAMESPACE(dump_polyveck_to_file)
void dump_polyveck_to_file(polyveck *v, char *name, const char *filename);

#define dump_polyvecl_to_file DILITHIUM_NAMESPACE(dump_polyvecl_to_file)
void dump_polyvecl_to_file(polyvecl *v, char *name, const char *filename);
